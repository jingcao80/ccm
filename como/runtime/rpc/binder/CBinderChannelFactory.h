...
#ifndef __COMO_CBINDERCHANNELFACTORY_H__
#define __COMO_CBINDERCHANNELFACTORY_H__

#include "comoref.h"

namespace como {

class CBinderChannelFactory
    : public LightRefBase
    , public IRPCChannelFactory
{
public:
    CBinderChannelFactory(
        /* [in] */ RPCType type);
...
#endif // __COMO_CBINDERCHANNELFACTORY_H__
