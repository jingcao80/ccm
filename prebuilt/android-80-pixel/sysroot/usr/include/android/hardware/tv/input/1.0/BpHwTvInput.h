...
struct BpHwTvInput : public ::android::hardware::BpInterface<ITvInput>, public ::android::hardware::details::HidlInstrumentor {
    ...
    ::android::hardware::Return<void> setCallback(const ::android::sp<ITvInputCallback>& callback) override;
    ...
    ::android::hardware::Return<Result> closeStream(int32_t deviceId, int32_t streamId) override;
