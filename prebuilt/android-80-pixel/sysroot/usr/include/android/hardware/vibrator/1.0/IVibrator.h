...
struct IVibrator : public ::android::hidl::base::V1_0::IBase {
    ...
    virtual ::android::hardware::Return<Status> on(uint32_t timeoutMs) = 0;

    virtual ::android::hardware::Return<Status> off() = 0;

    virtual ::android::hardware::Return<bool> supportsAmplitudeControl() = 0;

    virtual ::android::hardware::Return<Status> setAmplitude(uint8_t amplitude) = 0;

    using perform_cb = std::function<void(Status status, uint32_t lengthMs)>;
    virtual ::android::hardware::Return<void> perform(Effect effect, EffectStrength strength, perform_cb _hidl_cb) = 0;
    ...
    static ::android::hardware::Return<::android::sp<IVibrator>> castFrom(const ::android::sp<IVibrator>& parent, bool emitError = false);
    static ::android::hardware::Return<::android::sp<IVibrator>> castFrom(const ::android::sp<::android::hidl::base::V1_0::IBase>& parent, bool emitError = false);
...
std::string toString(const ::android::sp<IVibrator>&);
