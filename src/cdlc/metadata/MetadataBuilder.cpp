    ...
    /* [in] */ Module* module)
{
    ...
    mc->mExternalEnumerationNumber = module->GetExternalEnumerationNumber();
    mc->mInterfaceNumber = IN;
    mc->mExternalInterfaceNumber = module->GetExternalInterfaceNumber();
    mc->mTypeNumber = TN;
    // mNamespaces address
    mBasePtr = ALIGN(mBasePtr + sizeof(como::MetaComponent));
    ...
    /* [in] */ EnumerationType* enumeration)
{
    ...
    me->mProperties = enumeration->IsExternal() ? TYPE_EXTERNAL : 0;
    // mExternalModuleName address if needed
    mBasePtr = ALIGN(mBasePtr + sizeof(como::MetaEnumeration));
    ...
    /* [in] */ InterfaceType* interface)
{
    ...
    mi->mMethodNumber = MN;
    mi->mProperties = interface->IsExternal() ? TYPE_EXTERNAL : 0;
    // mExternalModuleName address if needed
    mBasePtr = ALIGN(mBasePtr + sizeof(como::MetaInterface));
