...
#ifndef __CCM_CORE_NATIVESCOPEDTHREADSTATECHANGE_H__
#define __CCM_CORE_NATIVESCOPEDTHREADSTATECHANGE_H__
...
#endif // __CCM_CORE_NATIVESCOPEDTHREADSTATECHANGE_H__
