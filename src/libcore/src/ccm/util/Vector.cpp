...
CCM_INTERFACE_IMPL_4(Vector, AbstractList, IVector, IRandomAccess, ICloneable, ISerializable);
...
CCM_INTERFACE_IMPL_1(Vector::Itr, SyncObject, IIterator);
...
CCM_INTERFACE_IMPL_1(Vector::ListItr, Vector::Itr, IListIterator);
