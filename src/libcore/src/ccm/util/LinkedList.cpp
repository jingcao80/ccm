...
CCM_INTERFACE_IMPL_5(LinkedList, AbstractSequentialList, ILinkedList, IDeque, IQueue, ICloneable, ISerializable);
...
CCM_INTERFACE_IMPL_2(LinkedList::ListItr, SyncObject, IListIterator, IIterator);
...
CCM_INTERFACE_IMPL_1(LinkedList::DescendingIterator, SyncObject, IIterator);
