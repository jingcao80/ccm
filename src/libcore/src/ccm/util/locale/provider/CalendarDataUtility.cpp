...
using ccm::text::CDateFormatSymbols;
using ccm::text::IID_IDateFormatSymbols;
...
ECode CalendarDataUtility::RetrieveCCMTimeFieldValueName(
    /* [in] */ const String& id,
    /* [in] */ Integer field,
    /* [in] */ Integer value,
    /* [in] */ Integer style,
...
ECode CalendarDataUtility::RetrieveCCMTimeFieldValueNames(
    /* [in] */ const String& id,
    /* [in] */ Integer field,
    /* [in] */ Integer style,
    /* [in] */ ILocale* locale,
