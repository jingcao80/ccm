...
#include "ccm.core.IAnnotation.h"
...
CCM_INTERFACE_IMPL_1(AttributeEntry, SyncObject, IMapEntry);
...
CCM_INTERFACE_IMPL_3(AttributedString::AttributedStringIterator, SyncObject,
    ...
    /* [out] */ Char* currChar)
{
    ...
    *currChar = InternalSetIndex(position);
    return NOERROR;
}
    ...
    /* [out] */ ISet** keys)
{
    ...
    }
    {
        ...
        AutoPtr<ISet> _keys;
        CHashSet::New(IID_ISet, (IInterface**)&_keys);
        Integer i = 0;
    ...
    /* [out] */ IInterface** value)
{
    ...
    mOwner->GetAttributeCheckRange(attribute, runIndex, mBeginIndex, mEndIndex).MoveTo(value);
    return NOERROR;
}
