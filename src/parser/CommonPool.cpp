...
bool CommonPool::AddEnumeration(
...
Enumeration* CommonPool::FindEnumeration(
...
Interface* CommonPool::FindInterface(
...
Namespace* CommonPool::ParseNamespace(
...
Namespace* CommonPool::FindNamespace(
    /* [in] */ const String& nsString)
{
    for (int i = 0; i < mNSIndex; i++) {
        Namespace* ns = mNamespaces[i];
...
bool CommonPool::AddTemporaryType(
    /* [in] */ Type* type)
{
...
bool CommonPool::EnlargeEnumerationArray()
{
...
bool CommonPool::EnlargeInterfaceArray()
{
...
bool CommonPool::EnlargeNamespaceArray()
{
...
bool CommonPool::EnlargeTempTypeArray()
{
...
String CommonPool::Dump(
    /* [in] */ const String& prefix)
{
    StringBuilder buider;

    buider.Append("CommonPool[").Append(mRootFile).Append("]\n");
    for (int i = 0; i < mEnumIndex; i++) {
