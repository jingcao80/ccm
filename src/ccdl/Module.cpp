...
Enumeration* Module::FindEnumeration(
...
Interface* Module::FindInterface(
...
Namespace* Module::ParseNamespace(
...
Namespace* Module::FindNamespace(
    /* [in] */ const String& nsString)
{
    for (int i = 0; i < mNSIndex; i++) {
        Namespace* ns = mNamespaces[i];
...
bool Module::EnlargeEnumerationArray()
{
...
bool Module::EnlargeInterfaceArray()
{
...
bool Module::EnlargeNamespaceArray()
{
...
bool Module::EnlargeTempTypeArray()
{
