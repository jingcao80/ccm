...
using como::util::IGregorianCalendar;
...
COMO_INTERFACE_IMPL_1(SimpleDateFormat, DateFormat, ISimpleDateFormat);
...
{
    return GetCalendarName().Equals("como.util.CGregorianCalendar");
}
