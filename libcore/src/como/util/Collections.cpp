...
COMO_INTERFACE_IMPL_1(Collections::UnmodifiableSet, UnmodifiableCollection, ISet);
...
COMO_INTERFACE_IMPL_1(Collections::UnmodifiableList, UnmodifiableCollection, IList);
...
COMO_INTERFACE_IMPL_1(Collections::UnmodifiableRandomAccessList, UnmodifiableList, IRandomAccess);
...
COMO_INTERFACE_IMPL_1(Collections::SynchronizedSet, SynchronizedCollection, ISet);
...
COMO_INTERFACE_IMPL_1(Collections::SynchronizedList, Collections::SynchronizedCollection, IList);
...
COMO_INTERFACE_IMPL_1(Collections::SynchronizedRandomAccessList, Collections::SynchronizedList, IRandomAccess);
...
COMO_INTERFACE_IMPL_1(Collections::ReverseComparator, Object, IComparator);
...
COMO_INTERFACE_IMPL_1(Collections::ReverseComparator2, Object, IComparator);
