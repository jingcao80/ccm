...
using como::io::CFile;
using como::io::CFileOutputStream;
using como::io::COutputStreamWriter;
using como::io::IFile;
using como::io::IID_ICloseable;
using como::io::IID_IFile;
using como::io::IID_IFlushable;
using como::io::IID_IOutputStream;
using como::io::IID_IWriter;
...
using como::misc::FormattedFloatingDecimal;
using como::misc::FormattedFloatingDecimalForm;
using como::misc::IFormattedFloatingDecimal;
using como::text::DateFormatSymbols;
using como::text::DecimalFormatSymbols;
using como::text::IDecimalFormat;
using como::text::IDecimalFormatSymbols;
using como::text::INumberFormat;
using como::text::NumberFormat;
using como::util::Calendar;
...
COMO_INTERFACE_IMPL_4(Formatter, SyncObject, IFormatter, ICloseable, IFlushable, IAutoCloseable);
    ...
    /* [out] */ ICharset** cs)
{
    ...
    return SUCCEEDED(ec) ? NOERROR : como::io::E_UNSUPPORTED_ENCODING_EXCEPTION;
}
...
COMO_INTERFACE_IMPL_LIGHT_1(Formatter::FormatSpecifier, LightRefBase, IFormatString);
