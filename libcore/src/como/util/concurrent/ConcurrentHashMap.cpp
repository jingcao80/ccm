...
#include "como/util/concurrent/ConcurrentHashMap.h"
...
using como::core::Runtime;
using como::io::IID_ISerializable;
using como::util::concurrent::locks::LockSupport;
...
COMO_INTERFACE_IMPL_2(ConcurrentHashMap::CollectionView, SyncObject, ICollection, ISerializable);
...
COMO_INTERFACE_IMPL_1(ConcurrentHashMap::KeySetView, CollectionView, ISet);
...
COMO_INTERFACE_IMPL_1(ConcurrentHashMap::EntrySetView, CollectionView, ISet);
