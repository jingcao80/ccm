...
#include "ccm.text.IChoiceFormat.h"
...
CCM_INTERFACE_IMPL_1(MessageFormat, BaseFormat, IMessageFormat);
...
CCM_INTERFACE_IMPL_1(MessageFormat::Field, BaseFormat::Field, IMessageFormatField);
