...
#ifndef __COMO_IO_DIRECTBYTEBUFFER_H__
#define __COMO_IO_DIRECTBYTEBUFFER_H__

#include "como/io/MappedByteBuffer.h"
#include "como.io.channels.IDirectBuffer.h"

using como::io::channels::IDirectBuffer;
