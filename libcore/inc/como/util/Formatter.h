...
#ifndef __COMO_UTIL_FORMATTER_H__
#define __COMO_UTIL_FORMATTER_H__
...
using como::io::ICloseable;
using como::io::IFile;
using como::io::IFlushable;
...
private:
    ...
    public:
        ...
        // como.util.CDate, como.util.CCalendar, long
