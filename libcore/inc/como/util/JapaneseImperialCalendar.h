...
#ifndef __COMO_UTIL_JAPANESEIMPERIALCALENDAR_H__
#define __COMO_UTIL_JAPANESEIMPERIALCALENDAR_H__

#include "como/util/Calendar.h"
#include "como/util/calendar/LocalGregorianCalendar.h"
#include "como.core.ILong.h"
#include "como.util.IJapaneseImperialCalendar.h"
...
using como::util::calendar::LocalGregorianCalendar;
...
private:
    ...
    /**
     * jdate always has a como::util::calendar::LocalGregorianCalendar::Date instance to
