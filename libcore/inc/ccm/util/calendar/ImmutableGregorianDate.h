...
#ifndef __CCM_UTIL_CALENDAR_IMMUTABLEGREGORIANDATE_H__
#define __CCM_UTIL_CALENDAR_IMMUTABLEGREGORIANDATE_H__
...
#endif // __CCM_UTIL_CALENDAR_IMMUTABLEGREGORIANDATE_H__
